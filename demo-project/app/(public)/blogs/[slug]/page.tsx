...
const SEED_MAP: Record<string, { title: string; excerpt: string; category: string; readTime: string; coverImage: string | null; author: string }> = {
  'rupexa-payment-gateway-integration': { title:'How Rupexa Simplifies Payment Gateway Integration for Indian and International Merchants', excerpt:'India\'s digital payment ecosystem is booming — and global commerce is growing just as fast. Rupexa makes gateway integration fast, reliable and developer-friendly for Indian and international merchants of every business size.', category:'Payments', readTime:'6 Mins Read', coverImage:'/services/payment-gateway.jpg', author:'Rupexa Editorial' },
  ...
  'maharashtra-manufacturer-digital-journey': { title:'From Offline to Online: A Manufacturer\'s Digital Journey', excerpt:'Vijay Industries had zero digital presence in 2023. With Rupexa\'s platform and payment integration, they now generate 40% of revenue online.', category:'Customer Stories', readTime:'4 Mins Read', coverImage:null, author:'Rupexa Editorial' },
...
export default async function BlogPage({ params }: BlogPageProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-24 pb-20 font-sans">
      ...
      <section className="mt-10 relative bg-gradient-to-br from-blue-700 to-indigo-800 py-14 overflow-hidden">

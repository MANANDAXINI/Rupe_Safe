...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-950 text-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="border-t border-slate-800/70 mt-8 pt-8 text-sm text-center">
          <p className="text-slate-400">&copy; {currentYear} Rupexa Private Limited. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );

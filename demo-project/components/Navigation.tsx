            ...
            {loading ? (
              ...
              <div className="flex items-center gap-4">
                ...
                <Link href="/auth/signup">
                  <button className="bg-[#305eff] hover:bg-blue-700 text-white font-[600] px-5 py-[10px] rounded-[4px] shadow-sm text-[14px] flex items-center gap-2 tracking-tight transition-all">
                    Sign Up
            ...
            {loading ? (
              ...
              <div className="flex flex-col gap-3">
                ...
                <Link href="/auth/signup" onClick={() => setIsOpen(false)}>
                  <Button className="w-full bg-[#305eff] hover:bg-blue-700 text-white h-12 font-semibold">
                    Sign Up
                  </Button>
                </Link>
              </div>

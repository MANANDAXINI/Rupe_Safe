              ...
              >
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start">
                  <Link href={slides[index % slides.length]?.primaryLink || "#"} className="w-full sm:w-auto">
                    <button className="bg-[#305eff] hover:bg-blue-700 text-white px-7 py-3.5 rounded-[4px] text-[15px] font-[600] transition-all flex items-center justify-center gap-2 group w-full sm:w-auto">
                  ...
                  {slides[index % slides.length]?.secondaryCta && slides[index % slides.length]?.secondaryLink && (
                    <Link href={slides[index % slides.length]?.secondaryLink || "#"} className="w-full sm:w-auto">
                      <button className="bg-transparent hover:bg-blue-50 text-[#2950da] hover:text-[#1839b0] px-7 py-3.5 rounded-[4px] text-[15px] font-[600] transition-all w-full sm:w-auto flex items-center justify-center">
